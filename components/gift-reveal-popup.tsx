            ...
            <div className="text-center space-y-8">
              <div className="space-y-4">
                ...
                >
                  ...
                  <p className="text-xl text-red-800">off on Savart X</p>
                </motion.div>
              </div>
              ...
              >
                <p className="text-gray-600">
                  Thanks for participating! Our representative will contact you
                  soon.
                </p>
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="flex justify-center gap-6">
                    ...
                    >
                      <Image
                        src="http://awesome-coding.com/theme/images/icons/linkedin.png"
                        alt="Twitter"
                        width={32}
                        height={32}
                        className="w-8 h-8"
...
export default GiftRevealPopup;
